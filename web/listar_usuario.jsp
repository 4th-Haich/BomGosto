    ...
    <head>
        ...
        <script type="text/javascript">
            function excluir(id, nome) {
                ...
                if (confirm("Tem certeza que quer excluir o usuario: " + nome + "?")) {
                ...
                <div class="row">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div>
                                <button type="button" class="btn btn-sm btn-primary btn-create" onclick="window.location.href = 'form_inserir_usuario.jsp'"><em class="glyphicon glyphicon-plus"></em> Novo</button>
                            </div>
                        </div>
                        <div class="panel-body table-responsive">
                            <table  id="results" class="table table-striped table-bordered table-list table-hover">
                                ...
                                <tbody>
                                    <%
                                        for (Usuario u : lista) {
                                            if (uLogado.getPerfil().getId() <= u.getPerfil().getId()) {
                                    %>
                                    <tr>
                                        <td class="center"><%=u.getId()%></td>
                                        <td class="center"><%=u.getNome()%></td>
                                        <td class="center"><%=u.getTelefone()%></td>
                                        <td class="center">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="form_alterar_usuario.jsp?id=<%=u.getId()%>"><em class="fa fa-pencil"></em> Alterar</a></li>
                                                    <%--<li><a href="" onclick="excluir(<%=u.getId()%>, '<%=u.getNome()%>')"><em class="glyphicon glyphicon-trash"></em> Excluir</a></li>--%>
                                                </ul>
                                            </div>
                                        </td>
