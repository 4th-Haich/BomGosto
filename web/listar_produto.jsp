                ...
                <div class="row">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div>
                                <button type="button" class="btn btn-sm btn-primary btn-create" onclick="window.location.href = 'form_inserir_produto.jsp'"><em class="glyphicon glyphicon-plus"></em> Novo</button>
                            </div>
                        </div>
                            ...
                            <table  id="results" class="table table-striped table-bordered table-list table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="center"><%=p.getPrecoUnitario()%></td>
                                        <td class="center"><%=p.getImagem()%></td>
                                        <td class="center"><%=p.getCategoria().getNome() %></td>
                                        <td class="center">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="form_alterar_produto.jsp?id=<%=p.getId()%>"><em class="fa fa-pencil"></em> Alterar</a></li>
