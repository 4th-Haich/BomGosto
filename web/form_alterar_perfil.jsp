...
<html lang="pt-BR">
    ...
    <body>
        ...
        <section class="box-content box-2 box-style">
            <div class="container">
                <form data-toggle="validator" class="form-horizontal " method="post" action="gerenciar_perfil.do" name="form_perfil" id="form_perfil">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 inputGroupContainer">
                                <div class="input-group">
                                    ...
                                    <input maxlength="45" class="form-control" id="nome" name="nome" type="text" value="<%=p.getNome()%>" required autocomplete="off">
                                </div>
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label">Descrição<span class="req">*</span></label>  
                            <div class="col-md-4 inputGroupContainer">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-align-justify"></i></span>
                                    <input maxlength="45" class="form-control" id="descricao" type="text" name="descricao" placeholder="Descrição"<%=p.getDescricao()%> required autocomplete="off">                                  
                                </div>
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>                                
