    ...
    <head>
        ...
        <script type="text/javascript">
            function excluir(id, nome) {
                var url = "gerenciar_categoria.do?op=excluir&id=" + id;
                if (confirm("Tem certeza que quer excluir o categoria: " + nome + "?")) {
                ...
                <div class="row">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div>
                                <button type="button" class="btn btn-sm btn-primary btn-create" onclick="window.location.href = 'form_inserir_categoria.jsp'"><em class="glyphicon glyphicon-plus"></em> Novo</button>
                            </div>
                        </div>
                                        ...
                                        <td class="center">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="form_alterar_categoria.jsp?id=<%=c.getId()%>"><em class="fa fa-pencil"></em> Alterar</a></li>
