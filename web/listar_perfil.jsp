                        ...
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col col-xs-12">
                                    <h3 class="panel-title">Lista de Perfis</h3>                                    
                                </div>
                            </div>
                            <div>
                                <button type="button" class="btn btn-sm btn-primary btn-create" onclick="window.location.href = 'form_inserir_perfil.jsp'"><em class="glyphicon glyphicon-plus"></em> Novo</button>
                            </div>
                        </div>
                            ...
                            <table  id="results" class="table table-striped table-bordered table-list table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="center"><%=p.getDescricao()%></td>
                                        <td class="center">
                                            <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                <li><a href="form_alterar_perfil.jsp?id=<%=p.getId()%>"><em class="fa fa-pencil"></em> Alterar</a></li>
                                                <li><a href="form_gerenciar_menu_perfil.jsp?id=<%=p.getId()%>"><em class="glyphicon glyphicon-menu-hamburger"></em> Vincular</a></li>
                                                <%--<li><a href="" onclick="excluir(<%=p.getId()%>, '<%=p.getNome()%>')"><em class="glyphicon glyphicon-trash"></em> Excluir</a></li>--%>
                                            </ul>
                                            </div>
                                        </td>                                        
                                    </tr>  
